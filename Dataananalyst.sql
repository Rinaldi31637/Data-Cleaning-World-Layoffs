...
-- What producy line had the largest VAT?
SELECT product_line, AVG(tax_pct) avg_tax
FROM sales
GROUP BY product_line
...
SUM(tax_pct + cogs) as total_gross_sales,
(SUM(tax_pct + cogs) - SUM(cogs)) as total_gross_profit
FROM sales;
